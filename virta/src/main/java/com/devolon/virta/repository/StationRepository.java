...
public interface StationRepository extends JpaRepository<Station, Long> {
    ...
    @Query(value = "SELECT id,c_name, c_code,N_LATITUDE,N_LONGITUDE, round(distance,2) as n_distance, N_COMPANY_ID, C_COMMENT  " +
            "FROM (select id,c_name, c_code,N_LATITUDE,N_LONGITUDE,N_COMPANY_ID, C_COMMENT, " +
